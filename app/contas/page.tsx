...
export default async function Contas() {
  ...
  const oauthUrl = `https://www.facebook.com/v25.0/dialog/oauth?client_id=${process.env.META_APP_ID}&redirect_uri=${process.env.META_REDIRECT_URI}&scope=pages_show_list,pages_read_engagement,instagram_content_publish,instagram_manage_comments,business_management&response_type=code`
